...
html { font-size: 62.5%; }
body { font-size: 1em;}
/* SOURCE REFERENCE (Provided by Developer Gadhe Hariharan)*/
/* please credit the adopted pyramid shape to my reference at: (https://codepen.io/ZachSaucier) */
/* PYRAMID CODE */
.stage {
...
<html lang="en">
<head>
<title>Gadhe hariharan's Assessment</title>
<!-- Bootstrap -->
...
<div id="about">
<h1>
<div style='float: left; margin-bottom: 16px;'>Gadhe hariharan’s
</div>
<div class="stage">
<div class="pyramid3d">
...
<p id='pleft'>As requested by management, this is my final
product stage, demonstrating the automated, integrated, and
deployed spring-boot web application.</p>
<p id='pright'>This is an environment where the application is
...
<p>Feel free to contact Gadhe hariharan with any new requests or
